var MATIERE_AUTO = [
  {
    ...
    "cat": "Technique",
    "desc": "Le contrôle s'effectue **moteur froid et sur un plan horizontal**, le véhicule étant à l'arrêt. Le niveau d'huile indiqué par la jauge doit se situer entre le repère MIN et le repère MAX. Un niveau insuffisant provoque une usure anormale, voire un serrage du moteur par défaut de lubrification ; un excès peut détériorer les joints et le pot catalytique."
  },
  {
    "id": "auto_2",
    "titre": "Liquide de refroidissement",
    "cat": "Technique",
    "desc": "Le niveau se vérifie visuellement via le vase d'expansion transparent, sans dépasser le repère MAX. **Avertissement de sécurité :** ne jamais ouvrir le bouchon du réservoir de refroidissement lorsque le moteur est chaud ou sous pression, sous peine de brûlures graves."
  },
  {
    "id": "auto_3",
  ...
  },
  {
    ...
    "cat": "Technique",
    "desc": "La pression des pneus se vérifie **à froid** (ou en ajoutant 0,3 bar si les pneus sont chauds). Une pression inadaptée augmente la consommation de carburant, détériore la tenue de route et use prématurément la bande de roulement. La profondeur minimale légale des rainures principales est de **1,6 mm** pour les voitures particulières en Europe."
  },
  {
    "id": "auto_6",
    "titre": "Masse Maximale Autorisée (MMA / PTAC)",
    "cat": "Légal & Charges",
    "desc": "La **MMA** correspond au poids total maximal autorisé pour le véhicule en charge (véhicule vide + passagers + carburant + bagages). Cette valeur figure sur le certificat d'immatriculation (rubrique F.2). Il est strictement interdit de circuler en surcharge, ce qui altère la trajectoire, allonge les distances de freinage et fragilise les suspensions."
  },
  {
    "id": "auto_7",
