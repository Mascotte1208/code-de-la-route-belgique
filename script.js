...
// ---- PIEGES (10) ----
var PIEGES_ROUTES = [
    {id:"piege_1",titre:"Priorite a droite absolue",cat:"PIE",sousCat:"Pieges",desc:"Sans signalisation, priorite a droite s'applique toujours."},
    {id:"piege_2",titre:"Stationnement 5 metres",cat:"PIE",sousCat:"Pieges",desc:"Interdit de stationner a moins de 5m avant un passage pieton."},
    {id:"piege_3",titre:"Sortie chemin de terre",cat:"PIE",sousCat:"Pieges",desc:"Quiconque sort d'un chemin de terre doit toujours ceder le passage."},
    {id:"piege_4",titre:"Depassement cyclistes",cat:"PIE",sousCat:"Pieges",desc:"Marge laterale 1,0m en agglo, 1,5m hors agglo."},
    {id:"piege_5",titre:"Rond-point classique",cat:"PIE",sousCat:"Pieges",desc:"Un rond-point n'est prioritaire que s'il y a les panneaux B1 et D10."},
    {id:"piege_6",titre:"Feu orange fixe",cat:"PIE",sousCat:"Pieges",desc:"Le feu orange oblige a l'arret, sauf impossibilite de s'arreter."},
    {id:"piege_7",titre:"Feu vert et pietons",cat:"PIE",sousCat:"Pieges",desc:"Ceder le passage aux pietons meme si le feu est vert."},
    {id:"piege_8",titre:"Bande d'arret d'urgence",cat:"PIE",sousCat:"Pieges",desc:"Interdit de s'y arreter sauf force majeure."},
    {id:"piege_9",titre:"Sens de stationnement",cat:"PIE",sousCat:"Pieges",desc:"Se garer dans le sens de la marche du cote droit."},
    {id:"piege_10",titre:"Depassement par la droite autoroute",cat:"PIE",sousCat:"Pieges",desc:"Interdit sauf files ininterrompues."}
];
...
var CATEGORIES = {
    ...
    PIE:{label:"Pieges",color:"var(--orange)"},
...
var state={
    categories:["A","B","C","D","E","F","MECA","PNEU","SAI","SEC","LEG","EQ","MAR","CND","VEH","PSY","PIE","USA"],
    questionCount:15,
    timer:false,
    questions:[],
    index:0,
...
function renderGeneric(list, searchId, listId, titleKey, descKey, catKey) {
    ...
    if(results.length){
        ...
        for(var i=0;i<results.length;i++){
            ...
            html += '<div class="rule-card"><div class="info-header"><span class="badge" style="background:'+color+'">'+escapeHTML(badge)+'</span></div><b>'+escapeHTML(title)+'</b><p>'+escapeHTML(desc)+'</p></div>';
        }
